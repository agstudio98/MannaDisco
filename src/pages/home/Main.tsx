    ...
    <section className="relative min-h-[60vh] flex items-center overflow-visible">
      <div className="max-w-7xl mx-auto px-4 w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7 text-left z-10">
          <h1 className="text-8xl md:text-9xl lg:text-[12rem] font-lexend font-black text-white leading-[0.85] mb-8 -ml-2 drop-shadow-[10px_10px_0px_rgba(0,0,0,1)]">
            MANNA
            <br />
            <span className="text-7xl md:text-9xl text-yellow-400">DISCO</span>
          </h1>
          <p className="text-2xl md:text-4xl font-poiret max-w-xl leading-tight border-l-8 border-white pl-6">
            Descubre promociones en discos de vinilos, CDs retro y equipos de audio a precios imbatibles.
          </p>
          <div className="mt-12 flex gap-4">
             <button className="brutal-btn text-2xl px-8 py-4 bg-white text-black hover:bg-yellow-400 transition-colors">
               VER OFERTAS
             </button>
          </div>
        </div>
